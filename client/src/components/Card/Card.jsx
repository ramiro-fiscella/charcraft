...
const Card = () => {
  return (
    // CARD CONTAINER
    <div
      className="w-[224px] h-[308px] border-2 border-neutral-900 rounded-lg bg-neutral-900"
      id="card"
    >
      <div className="m-2 h-[90%] pt-2 px-1 mb-2 flex-row rounded rounded-b-2xl bg-neutral-200">
        {/* NOMBRE Y NIVEL */}
        <div
          className="w-[100%] h-6 p-[2px] flex justify-between content-center border-[1px] border-neutral-600 rounded-sm text-neutral-900"
        ...
        <div className="mx-1 h-36">
          <div
            className="w-full h-[80px] min-h-[80px] p-2 outline outline-1 outline-neutral-400 rounded-b bg-neutral-200 overflow-hidden hover:overflow-visible hover:h-auto"
          ...
          >
            <p className="text-xs leading-4 font-medium text-neutral-800 overflow-wrap break-word">
              ...
              impedit perspiciatis praesentium obcaecati, maiores iste.
            </p>
          </div>
        </div>
      </div>
