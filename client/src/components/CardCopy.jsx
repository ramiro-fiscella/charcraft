...
const CardCopy = ({ character, onClick }) => {
  return (
    // CARD CONTAINER
    <div
      className=" cursor-pointer w-[220px] h-[308px] rounded-lg bg-gradient-to-tl from-stone-950 to-slate-800  bg-blend-screen backdrop-blur-md border border-yellow-400  border-opacity-50 hover:border-opacity-90 hover:outline-double hover:outline-4 hover:outline-amber-500 transition-all duration-200 shadow-lg shadow-zinc-950"
      id="card"
      onClick={onClick}
    >
      <div className="m-2 h-[90%] pt-2 px-1 flex-row rounded rounded-b-2xl bg-gradient-to-b from-neutral-300 to-stone-200">
        ...
        <div className="mx-1 h-36">
          <div
            className="w-full h-[80px] min-h-[80px] p-2 outline outline-1 outline-neutral-500 rounded-b bg-gradient-to-b from-neutral-200 to-stone-100  text-[.7rem] text-pretty leading-none text-neutral-900  shadow-md shadow-stone-950 "
