...
const CharacterDetails = () => {
  ...
  return (
    <div className="h-full m-auto mt-14 p-5 bg-emerald-950">
      <div className="max-w-[1200px] m-auto grid grid-flow-row gap-4 ">
        <div className=" grid-cols-3 grid-flow-col inline-grid gap-4">
          <div id="character" className="data-container col-span-1 row-span-1">
          ...
          <div id="attributes" className="data-container col-span-1 row-span-1">
          ...
          <div id="skills" className="data-container col-span-1 row-span-2">
